const MONSTER_DB = {
    // Lv 1
    "포링": { name: "포링", element: "수", hp: 10, attack: 3, defense: 1, speed: 10, accuracy: 71, evasion: 5, luk: 0, exp: 15, jobExp: 10, gold: 10, dropTable: "포링" },
    "파브르": { name: "파브르", element: "지", hp: 14, attack: 4, defense: 2, speed: 11, accuracy: 73, evasion: 5, luk: 0, exp: 22, jobExp: 15, gold: 20, dropTable: "파브르" },
    "루나틱": { name: "루나틱", element: "무", hp: 12, attack: 5, defense: 2, speed: 11, accuracy: 74, evasion: 7, luk: 0, exp: 20, jobExp: 15, gold: 20, dropTable: "루나틱" },
